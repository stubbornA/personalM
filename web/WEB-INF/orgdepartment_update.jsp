...
<div class="container">
    ...
    <div class="row">
        <form action="http://localhost:8080/organize/organizeAction_OrganizeUpdate" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" name="oid" value="${organize==null?"":organize.oid}">
                                <input name="oname" class="form-control" value="${organize==null?"":organize.oname}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">负责人</label>
                            <div class="col-sm-8">
                                <input name="director"  class="form-control" value="${organize==null?"":organize.director}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">电话</label>
                            <div class="col-sm-8">
                                <input  name="phone" class="form-control" value="${organize==null?"":organize.phone}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">详细地址</label>
                            <div class="col-sm-8">
                                <input name="adress" class="form-control" value="${organize==null?"":organize.adress}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="ocode" class="form-control" value="${organize==null?"":organize.ocode}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">员工数量</label>
                            <div class="col-sm-8">
                                <input name="pnumber" class="form-control" value="${organize==null?"":organize.pnumber}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">部门标语</label>
                            <div class="col-sm-8">
                                <input  name="orgnote" class="form-control" value="${organize==null?"":organize.orgnote}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">邮箱</label>
                            <div class="col-sm-8">
                                <input  name="email" class="form-control" value="${organize==null?"":organize.email}" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-12 formpart" id="additionmains">
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="col-sm-12" style="margin-top: 15px">
            <div class="btn-group center-block" style="width: 160px">
                ...
                <button type="submit" class="btn btn-success center-block" id="formsubmit">&nbsp;<span class="glyphicon glyphicon-saved"></span> 修改&nbsp;</button>
            </div>
        </div>
        </form>
    </div>
