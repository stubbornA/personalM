    ...
    <div class="row">
        <div class="col-md-12" id="record">
            ...
            <div class="topcontent">
                <button type="button" class="btn recordbtn"><a href="http://localhost:8080/role/roleAction_towardRoleAdd"><span class="glyphicon glyphicon-plus"></span> 新增</a></button>
            </div>
        </div>
        <div class="col-md-12" >
            <div class="table-responsive" id="contentmain" >
                <table  class="table table-bordered filter-table">
                            ...
                            <div style="float: right">
                                <div class="btn-group" style="float: right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="javascript:void(0)"><input type="checkbox" checked="checked"> 角色描述</a></li>
                    ...
                    <tbody>
                    <s:iterator value="%{#request.rlist}" id="list" status="sta" >
                    <tr>
                        <td><s:property value="%{#sta.index+1}"/></td>
                        <td><s:property value="#list.rname"/></td>
                        <td><s:property value="#list.rdescribe"/></td>
                        <td class="btns">
                            <div class="btn-group center-block">
                                <button type="button" class="btn btn-danger"><a href="http://localhost:8080/role/roleAction_roleDelete?rid=${list.rid}"><span class="glyphicon glyphicon-trash"></span> 删除</a></button>
                            </div>
                        </td>
                    </tr>
                    </s:iterator>
