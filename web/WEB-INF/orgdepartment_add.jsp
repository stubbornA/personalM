...
<div class="container">
    ...
    <div class="row">
        <form action="http://localhost:8080/organize/organizeAction_OrganizeAdd" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="oname" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">负责人</label>
                            <div class="col-sm-8">
                                <input name="director"  class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">电话</label>
                            <div class="col-sm-8">
                                <input  name="phone" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">详细地址</label>
                            <div class="col-sm-8">
                                <input name="adress" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="ocode" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">员工数量</label>
                            <div class="col-sm-8">
                                <input name="pnumber" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">部门标语</label>
                            <div class="col-sm-8">
                                <input  name="orgnote" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label text-left">邮箱</label>
                            <div class="col-sm-8">
                                <input  name="email" class="form-control" value="" type="text" AUTOCOMPLETE=OFF />
                            </div>
                        </div>
                    </div>
                </div>
