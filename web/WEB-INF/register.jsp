...
<div class="container">
<form class="form-horizontal form" action="http://localhost:8080/account/AccountAction_register" id="form" role="form" >
    ...
    <div class="form-group">
        <label  class="col-sm-3 control-label">重复密码密码：</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control"  name="ocode"  placeholder="" />
        </div>
    </div>
    <input type="hidden" name="check" value="0">
    <div class="form-group" id="btn">
        <div class="col-sm-offset-3 col-sm-6">
            <button id="loginbtn" type="button" class="btn btn-info" style="float:left;width: 150px;">登录</button>
...
<script>
    $('#loginbtn').on('click',function () {
        window.location="http://localhost:8080/account/AccountAction_welcome";
    })
    $('#form').validate({
        rules:{
            password: {
