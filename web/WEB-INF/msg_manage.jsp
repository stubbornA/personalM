...
<div class="container">
    <div class="col-md-12" id="record">
        ...
        <div class="topcontent">
            <button type="button" class="btn btn-info recordbtn"><a href="http://localhost:8080/message/messageAction_towardMessageSend">
                <span class="glyphicon glyphicon-plus"></span> 新增消息</a>
            </button>
        </div>
    </div>
    <div class="col-md-12" >
        <div class="table-responsive" id="contentmain" >
            <table  class="table table-bordered">
                        ...
                        <div style="float: right">
                            <div class="btn-group" style="float: right">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="javascript:void(0)"><input type="checkbox" checked="checked"> 创建人</a></li>
                ...
                <tbody>
                <s:iterator value="%{#request.mlist}" id="list" status="statusid">
                <tr>
                    <td><s:property value="%{#statusid.index+1}"/></td>
                    <td><s:property value="#list.mtitle" /></td>
                    <td><s:property value="#list.username" /></td>
                    <td><s:property value="#list.mdate" /></td>
                    <td class="btns">
                        <button type="button" class="btn btn-success" style="width:33%;float: left;font-size: 12px"><a href="http://localhost:8080/message/messageAction_queryMessage?mid=${list.mid}"><span class="glyphicon glyphicon-search"></span> 查看</a></button>
                        <f:if test="${account.rid==1}">
                        <button type="button" class="btn btn-danger" style="width:33%;float: left;font-size: 12px"><a href="http://localhost:8080/message/messageAction_deleteMessage?mid=${list.mid}"><span class="glyphicon glyphicon-trash"></span> 删除</a></button>
                        </f:if>
                    </td>
                </tr>
                </s:iterator>
